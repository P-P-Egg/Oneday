...
public class di_tu : MonoBehaviour
{
    ...
    public void sky_bai()
    {
        ...
        if (yi_ci_sky == 1)
        {
            GameObject go = GameObject.Instantiate(sky_sz[0], new Vector3(-2.2f, 6.3f, 0), Quaternion.identity) as GameObject;
            sky.Add(go);
            yi_ci_sky = 0;
        }
        int x = sky.Count - 1;
    ...
    public void bj_shan_ff()
    {
        ...
        if (yi_ci_bjshan == 1)
        {
            GameObject go = GameObject.Instantiate(bj_shan_sz[0], new Vector3(suiji_xx, -5f, 0), Quaternion.identity) as GameObject;
            bj_shan.Add(go);
            yi_ci_bjshan = 0;
        }
    ...
    {
        int suiji_a = Random.Range(0,4);
        if (yi_ci_qjshuye == 1)
        {
            GameObject go = GameObject.Instantiate(qj_shuye1[suiji_a], new Vector2(-7f, -17.4f), Quaternion.identity) as GameObject;
            qj_shuye.Add(go);
            yi_ci_qjshuye = 0;
        }
    ...
    public void yun_ff()
    {
        int suiji_a = Random.Range(0, 7);
        if (yi_ci_yun == 1)
        {
            GameObject go = GameObject.Instantiate(yun_sz[suiji_a], new Vector2(-11f, 0f), Quaternion.identity) as GameObject;
            yun.Add(go);
            yi_ci_yun = 0;
        }
        int x = yun.Count - 1;
    ...
    public void teng_ff()
    {
        ...
        if (yi_ci_teng == 1)
        {
            GameObject go = GameObject.Instantiate(teng_sz[suiji_a], new Vector2(-21, 13), Quaternion.identity) as GameObject;
            teng.Add(go);
            yi_ci_teng = 0;
        }
        int x = teng.Count - 1;
        ...
        if (teng.Count <= 12)
        {
            GameObject sky_1 = GameObject.Instantiate(teng_sz[suiji_a], new Vector3(suiji_x, 0) + teng_wz, Quaternion.identity) as GameObject;
            teng.Add(sky_1);
        }
        if (teng[0] != null)
        {
